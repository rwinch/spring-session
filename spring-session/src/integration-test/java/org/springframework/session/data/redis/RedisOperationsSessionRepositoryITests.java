...
public class RedisOperationsSessionRepositoryITests extends AbstractITests {
	...
	public void saves() throws InterruptedException {
		...
		assertThat((Object)this.registry.getEvent(toSave.getId()))
		...
		assertThat((Object)session.getAttribute(expectedAttributeName))
		...
		assertThat((Object)this.registry.getEvent(toSave.getId()).getSession()
	...
	public void putAllOnSingleAttrDoesNotRemoveOld() {
		...
		assertThat((Object)session.getAttribute("a")).isEqualTo("b");
		assertThat((Object)session.getAttribute("1")).isEqualTo("2");
